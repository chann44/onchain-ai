...
export function MarketingHeader() {
    return <section className="min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
            ...
            <p className="max-w-2xl mx-auto text-xl text-secondary-foreground mb-8">
              Intelligent Market Analysis, Automated Risk-Free Investments, and AI-Driven Alphas for Meme Coin Mastery and High-Yield Opportunities 
            </p>
