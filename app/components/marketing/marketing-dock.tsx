...
import { BotMessageSquare, CalendarIcon, ChartNoAxesCombined, CircleFadingPlus, HomeIcon, MailIcon, PencilIcon } from "lucide-react";
...
const DATA = {
    navbar: [
        { href: "#", icon: BotMessageSquare, label: "Agents" },
